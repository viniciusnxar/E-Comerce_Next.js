...
function AdminsPage({swal}) {
  ...
  function deleteAdmin(_id, email) {
    swal.fire({
      ...
      text: `Você deseja excluir o administrador: ${email}?`,
        ...
        <tbody>
          ...
          {adminEmails.length > 0 && adminEmails.map(adminEmail => (
            <tr>
              ...
              <td>
                <button
                  onClick={() => deleteAdmin(adminEmail._id, adminEmail.email)} className="btn-red">Excluir</button>
              </td>
            </tr>
          ))}
        </tbody>
